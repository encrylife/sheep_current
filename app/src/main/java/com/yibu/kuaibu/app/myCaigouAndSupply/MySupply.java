 ...
 *
 */
public class MySupply extends Activity implements OnClickListener
{
	...
	protected void onCreate(Bundle savedInstanceState)
	{
		...
		setContentView(R.layout.my_supply);
        ...
        mListView.setOnItemClickListener(new OnItemClickListener()
		{
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int position,
					long arg3)
			{
				Intent intent = new Intent(MySupply.this, CaigouDetails.class);
				intent.putExtra("itemid",
						caigouItemGson.data.rslist.get(position-1).itemid);
				MySupply.this.startActivity(intent);
			}
		});
	...
	private void initData(final boolean ispullordown)
	{
		...
		try
		{
			...
			httpClientUtil.postRequest(
					"http://www.51kuaibu.com/app/getSellList.php", datas);
		} catch (Exception e)
		{
			e.printStackTrace();
		}
