...
//										.getInt("scrollnum") : 3);
                                ...
                                muser.setUserid(JsonUtils.getJsonString(dataobj, "userid"));

                                muser.setAvatar(JsonUtils.getJsonString(dataobj, "avatar"));
                                muser.setTruename(JsonUtils.getJsonString(dataobj, "truename"));
                                muser.setGroupid(JsonUtils.getJsonInt(dataobj, "groupid"));
                                muser.setAreaid(JsonUtils.getJsonInt(dataobj, "areaid"));
                                muser.setArea(JsonUtils.getJsonString(dataobj, "area"));
                                muser.setMobile(JsonUtils.getJsonString(dataobj, "mobile"));
                                muser.setCredit(JsonUtils.getJsonInt(dataobj, "credit"));
                                muser.setMoney(JsonUtils.getJsonDouble(dataobj, "money"));
                                muser.setLocking(JsonUtils.getJsonDouble(dataobj, "locking"));
                                muser.setCompany(JsonUtils.getJsonString(dataobj, "company"));
                                muser.setThumb(JsonUtils.getJsonString(dataobj, "thumb"));
                                muser.setTelephone(JsonUtils.getJsonString(dataobj, "telephone"));
                                muser.setCatid(JsonUtils.getJsonString(dataobj, "catid"));
                                muser.setCatname(JsonUtils.getJsonString(dataobj, "catname"));
                                muser.setBusiness(JsonUtils.getJsonString(dataobj, "business"));
                                muser.setAddress(JsonUtils.getJsonString(dataobj, "address"));
                                muser.setIntroduce(JsonUtils.getJsonString(dataobj, "introduce"));
                                muser.setFriendtotal(JsonUtils.getJsonInt(dataobj, "friendtotal"));
                                muser.setSelltotal(JsonUtils.getJsonInt(dataobj, "selltotal"));
                                muser.setBuytotal(JsonUtils.getJsonInt(dataobj, "buytotal"));
...
//										.getDouble("friend") : 0
                                ...
                                muser.setVmobile(JsonUtils.getJsonInt(dataobj, "vmobile"));

                                muser.setVtruename(JsonUtils.getJsonString(dataobj, "vtruename"));
                                muser.setVcompany(JsonUtils.getJsonString(dataobj, "vcompany"));
                                muser.setEmpass(JsonUtils.getJsonString(dataobj, "empass"));
