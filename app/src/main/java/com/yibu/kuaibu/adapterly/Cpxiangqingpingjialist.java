...
public class Cpxiangqingpingjialist {
    ...
    public Cpxiangqingpingjialist(String ids,String iconurl, String musername, String mcontenttext,String mpltime, String mguigefenlei,OnClickListener abenClick) {
    	this.itemid = ids;
